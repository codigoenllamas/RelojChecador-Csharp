...
namespace PersonalNet
{
    ...
    class PrintDGV
    {
        ...
        private static string PrintTitle = "LISTA DE REGISTRO";  // Header of pages
    ...
    private  string _xpersonal;
	public  string xpersonal { get {return _xpersonal;} set {_xpersonal=value;}	 } 
                ...
                while (RowPos <= dgv.Rows.Count - 1)
                {
                    ...
                    else
                    {
                        if (NewPage)
                        {
                            // Draw Header
                       /*
								Bitmap ima = new Bitmap(@"C:\\Intel\txps.jpg");
								   float newWidth = ima.Width * 10 / ima.HorizontalResolution;  // Convert to same units (100 ppi) as e.MarginBounds.Width
					                float newHeight = ima.Height * 10 / ima.VerticalResolution;   // Convert to same units (100 ppi) as e.MarginBounds.Height
									    ...
									    if(widthFactor>1 | heightFactor > 1) // if the image is wider or taller than the printable area then adjust...
									    {
									     ...
									     //(imagen,posicionX,PosicionY       
									    e.Graphics.DrawImage(ima, 50, 10, (int)newWidth, (int)newHeight);
					*/
                            /*
                           ...
                           */
                            ...
                            String s = "LISTA DE REGISTRO       Fecha de Impresión:"+DateTime.Now.ToLongDateString() + ":" + DateTime.Now.ToShortTimeString();
